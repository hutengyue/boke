    ...
    <el-card class="user-card" shadow="hover">
      <template #header>
        <div class="card-header">
          ...
          <div class="actions">
            <el-button type="primary" :icon="Plus" @click="data.dialog = true;data.type = 1;">新增分类</el-button>
      ...
      <el-table :data="data.list" style="width: 100%" :border="false" :stripe="true"
        ...
        <el-table-column fixed prop="categoryId" label="编号" min-width="5%" />
        <el-table-column prop="categoryName" label="分类名称" min-width="15%" />
...
async function fetchCategorys() {
  try {
    const res = await proxy.$http.get('/category/page', {
      params: {
