...
<template>
  <div v-slide-in @click="gotoArticle(article.articleId)" class="article-container">
    ...
    <div class="article-message">
      <div class="article-message-header">
        ...
        <div class="article-message-comment">
          ...
          <p>{{article.commentsCount}}评论</p>
        </div>
      </div>
      <p class="article-message-title">{{article.articleTitle}}</p>
      <p class="article-label">{{article.articleLabel}}</p>
      <div class="article-category">
        ...
        <div v-if="article.tags.length">
          ...
          <p v-for="(tag,index) in article.tags" :key="index">{{ tag.tagName }}</p>
        </div>
      </div>
    </div>
  </div>
