...
<template>
  <div class="container">
    ...
    <div class="container-article">
      <div class="article" >
        <div @click="gotoArticle(item.articleId)" v-for="(item,index) in data.articles" :key="index" v-slide-in class="article-container">
...
.article-category div:nth-child(2) p{
  margin-right: 10px;
}
.article-img-right{
  float: right;
